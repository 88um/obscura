...
async fn op_fetch_url(
    ...
    if let Some((tx, request_id, page_id)) = intercept_tx {
...
mod tests {
    use super::{
        build_request_client, FetchCredentials, ObscuraState, cors_response_allows, cors_unsafe_request_header_names,
